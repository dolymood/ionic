 ...
 * @param {boolean=} force-refresh-images Force images to refresh as you scroll. This fixes a bug
...
function CollectionRepeatDirective($ionicCollectionManager, $parse, $window) {
  ...
  function postLink(scope, element, attr, scrollCtrl, transclude) {
    ...
    // collectionBufferSize is deprecated
    ...
    // collectionItemHeight is deprecated
    var heightExpr = attr.itemHeight || attr.collectionItemHeight;
    // collectionItemWidth is deprecated
